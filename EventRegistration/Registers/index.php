                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="add.php" name="add" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="event" class="form-control">
                                                    <option value="5">Project Presentation - COMEIT</option>
                                                    <option value="2">Paper Presentation - COMEIT</option>
                                                    <option value="3">Clash of Code - COMEIT</option>
                                                    <option value="4">Webber - COMEIT</option>
                                                    <option value="1">Counter Strike - COMEIT</option>
                                                    <option value="6">Hotkeys - COMEIT</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Add Entry</button>
